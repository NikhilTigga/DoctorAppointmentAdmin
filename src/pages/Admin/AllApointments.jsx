...
const AllAppointments = () => {
    ...
    return(
        <div className="w-full max-w-6xl m-5 ">
            ...
            <div className="bg-white borser rounded ext-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll">
                ...
                {appointments.map((item,index)=>(
                    <div className="grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50 max-sm:gap-2"
